            ...
            <div class="row">
                ...
                <div class="col-lg-5 sm-margin-30px-bottom">
                    <div class="item text-center active">
                        ...
                        <p>Our Invest-Assets LP fund is one of our funds which gives investors direct profit opportunities.</p>
                        <div class="order">
                ...
                <div class="col-lg-5 sm-margin-30px-bottom">
                    <div class="item text-center active">
                        ...
                        <p>Our Invest-Assets 2.0 is our longterm ecosystem blockchain trust in protocols with our Web 3 partners on 3x scale.</p>
                        <div class="order">
